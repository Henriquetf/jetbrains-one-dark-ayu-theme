...
> [One Dark](https://github.com/atom/one-dark-syntax) theme + [One Dark Pro](https://github.com/Binaryify/OneDark-Pro) for JetBrains.
...
- Thanks to the maintainers of [JetBrains One Dark Theme](https://github.com/one-dark/jetbrains-one-dark-theme/) for creating the original project.
- Thanks to the maintainers of [One Dark Pro for VSCode](https://github.com/Binaryify/OneDark-Pro) for the Ayu color scheme.
- Thanks to the maintainers of [Material Theme UI for JetBrains](https://github.com/ChrisRM/material-theme-jetbrains) for the editor color scheme.
